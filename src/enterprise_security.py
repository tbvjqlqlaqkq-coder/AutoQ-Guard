...
ROLE_PERMISSIONS = {
    "ADMIN": {"VIEW_DASHBOARD", "SEARCH", "IMPORT_PREVIEW", "IMPORT_APPROVE", "MANAGE_USERS", "VIEW_AUDIT", "MANAGE_QUALITY_CASES"},
    "QUALITY": {"VIEW_DASHBOARD", "SEARCH", "IMPORT_PREVIEW", "MANAGE_QUALITY_CASES"},
