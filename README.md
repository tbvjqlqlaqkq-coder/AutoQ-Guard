...
최근 추가: [기업 파일럿 계획](docs/ENTERPRISE_PILOT_PLAN.md) · [잡음·경계조건 강건성 시험](docs/SYNTHETIC_ROBUSTNESS_TEST.md) · [임계값·비용 민감도 시험](docs/THRESHOLD_COST_TRADEOFF.md) · [안전등급별 정책 비교](docs/SAFETY_CLASS_POLICY.md). 경보 원본을 보존하며 실제 리콜 예방·기업 ROI를 확정하지 않습니다.
...
| 공개 리콜 선행신호 백테스트 | [월말·관찰완료 재평가](docs/model_validation/MATURE_BACKTEST.md): 판정 대기 분리 및 관측 대상 제한 | 공개 시점 미검증, 제한 모집단의 과거 재평가 |
...
|---|---|---|---|
| A · 공개 관측 | NHTSA 기반 현대·기아 공개자료 | 과거 재현: 행 단위 탐지율 **20.6%**, 에피소드 정밀도 **8.1%**, 중앙 선행기간 **4.5개월** | 독립 예측 성능 미확정; 738행은 고유 캠페인 214개 |
