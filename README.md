...
최근 추가: [기업 파일럿 계획](docs/ENTERPRISE_PILOT_PLAN.md) · [잡음·경계조건 강건성 시험](docs/SYNTHETIC_ROBUSTNESS_TEST.md) · [임계값·비용 민감도 시험](docs/THRESHOLD_COST_TRADEOFF.md). 경보 원본을 보존하며 실제 리콜 예방·기업 ROI를 확정하지 않습니다.
